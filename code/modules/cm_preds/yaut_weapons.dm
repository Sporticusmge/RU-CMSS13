...
/obj/item/weapon/gun/energy/yautja/plasma_caster
	...
	force = 0
	fire_delay = 3
	throw_speed = MIN_SPEED // RUCM ADD
	flags_atom = FPRINT|QUICK_DRAWABLE|CONDUCT
	//flags_item = NOBLUDGEON|DELONDROP|IGNITING_ITEM //Can't bludgeon with this. // RUCM REMOVE
	flags_item = NOBLUDGEON|DELONDROP|IGNITING_ITEM|ITEM_UNCATCHABLE // RUCM ADD
	flags_gun_features = GUN_UNUSUAL_DESIGN
