...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/populate_product_list(scale)
	listed_products = list(
		...
		list("Marine Jungle Combat Boots", floor(scale * 15), /obj/item/clothing/shoes/marine/jungle, VENDOR_ITEM_REGULAR), // RUCM ADD
		...
		list("Squad Optics", floor(scale * 10), /obj/item/device/helmet_visor, VENDOR_ITEM_REGULAR), // RUCM ADD
...
/obj/structure/machinery/cm_vending/sorted/attachments/squad/populate_product_list(scale)
	listed_products = list(
		...
		list("Barrel Charger", round(scale * 1), /obj/item/attachable/heavy_barrel, VENDOR_ITEM_REGULAR),
