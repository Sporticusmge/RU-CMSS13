...
//	item_icons = 'fray-marines/icons/obj/items/nailgun_onmob.dmi'
	item_icons = list(
		WEAR_WAIST = 'fray-marines/icons/obj/items/nailgun_onmob.dmi',
		WEAR_L_HAND = 'fray-marines/icons/obj/items/items_lefthand.dmi',
		WEAR_R_HAND = 'fray-marines/icons/obj/items/items_righthand.dmi'
		)
